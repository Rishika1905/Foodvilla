...
function Navbar({ onSearch, searchQuery }) {
  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-black" style={{ fontFamily: "'Dancing Script', cursive" }}>
      <div className="container-fluid mx-5 ms-2">
        <Link className="navbar-brand fs-1 fw-bold fst-italic text-danger" style={{ fontSize: "75px" }} to="/">
